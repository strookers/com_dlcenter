...
/**
 * Methods supporting a list of Dlcenter records.
 */
class DlcenterModelDownloads extends JModelList
{
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__dlcenter_download` AS a');
    ...
    $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
		...
		// Join over the foreign key 'emneid'
		$query->select('#__dlcenter_emne_2003960.title AS emner_title_2003960');
		$query->join('LEFT', '#__dlcenter_emne AS #__dlcenter_emne_2003960 ON #__dlcenter_emne_2003960.id = a.emneid');

		
if (!JFactory::getUser()->authorise('core.edit.state', 'com_dlcenter'))
{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_DLCENTER_SEARCH_FILTER_DATE_FORMAT"), "warning");
